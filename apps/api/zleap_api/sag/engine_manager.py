...
from zleap_api.sag.dto import EntityInfo, ProcessOutcome, RetrievedSection, SearchOutcome
from zleap_api.sag.errors import map_sag_errors
...
class EngineManager:
    ...
    async def get_chunk(
        ...
        *,
        ...
        from zleap_api.sag.dto import ChunkInfo
