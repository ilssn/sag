...
from zleap_api.core.errors import UpstreamError, ValidationError
    ...
    async def fetch(self, config: dict[str, Any], doc: DiscoveredDoc) -> LocalFile:
        try:
            async with httpx.AsyncClient(
                ...
                headers={"User-Agent": "zleap-bot/0.1 (+https://github.com/ilssn/zleap)"},
            ) as client:
        ...
        path = os.path.join(tempfile.gettempdir(), f"zleap-web-{digest}.md")
