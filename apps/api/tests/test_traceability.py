"""引用溯源：chunk 原文端点 + citations 的 muse source_id 语义。"""
...
async def test_chunk_endpoint_and_citation_refs():
    ...
    from muse_api.generation.prompt import build_citations
    from muse_api.main import app
    from muse_api.sag.dto import RetrievedSection
    ...
    async with app.router.lifespan_context(app):
        async with httpx.AsyncClient(transport=transport, base_url="http://t") as c:
            ...
            # citations：source_id 应为 muse 信源 id（非引擎内部 id）
