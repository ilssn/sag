...
- **星系即内容（定稿）**：整团粒子星云拉远看全貌，事件按自身身份点亮在星系旋臂原位——
  "靠近的粒子看清了变成星星"。滚轮只推进数据流（点亮区域沿星系推移），相机完全归还：
  拖拽环绕、捏合凑近读卡，入场即框住整团星系；明暗改为窗口带语义（窗口=星、掠过=余烬、
  未达=尘埃），与相机无关。潜入/雾包裹/洋葱/走廊等所有"进入式"机构退役。
