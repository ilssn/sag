...
const DOCUMENTS = [
  ...
  },
  {
    slug: "tooling",
    title: "工具链概览",
    description: "参考工具、知识系统适配层和核心领域对象。",
    group: "构建与集成",
    section: "docs",
    href: "/docs/tooling",
  ...
  },
  {
    slug: "creating-octx",
    title: "创建 OCTX",
    description: "首次创建、派生资产和 Release 版本保护。",
    group: "构建与集成",
    section: "docs",
    href: "/docs/creating-octx",
    file: "creating-octx.md",
  },
  {
    slug: "opening-validating-octx",
    title: "打开与校验",
    description: "安全读取、完整校验和结构化错误报告。",
    group: "构建与集成",
    section: "docs",
    href: "/docs/opening-validating-octx",
    file: "opening-validating-octx.md",
  },
  {
    slug: "importing-octx",
    title: "导入与安装",
    description: "OCTX 导入、升级、冲突处理、索引和本地重建。",
    group: "构建与集成",
    section: "docs",
    href: "/docs/importing-octx",
    file: "importing-octx.md",
  },
  {
    slug: "exporting-octx",
    title: "导出与配置",
    description: "OCTX 导出和本地配置边界。",
    group: "构建与集成",
    section: "docs",
    href: "/docs/exporting-octx",
    file: "exporting-octx.md",
  },
  {
    slug: "glossary",
  ...
  },
  {
    slug: "create-result",
    title: "CreateResult",
    description: "读取 create_octx() 返回的路径、身份、版本、摘要与校验报告。",
    group: "数据对象",
    section: "api",
    href: "/api/create-result",
    file: "api/create-result.md",
  },
  {
    slug: "document",
    title: "Document",
    description: "读取 Package 中 Markdown 文档的路径、frontmatter、正文和原始字节。",
    group: "数据对象",
    section: "api",
    href: "/api/document",
    file: "api/document.md",
  },
  {
    slug: "validation-report",
    title: "ValidationReport",
    description: "理解完整校验结果、声明层状态以及结构化问题列表。",
    group: "数据对象",
    section: "api",
    href: "/api/validation-report",
    file: "api/validation-report.md",
  },
  {
    slug: "archive-limits",
    title: "ArchiveLimits",
    description: "配置创建、打开、校验和解包时使用的资源安全上限。",
    group: "数据对象",
    section: "api",
    href: "/api/archive-limits",
    file: "api/archive-limits.md",
  },
  {
    slug: "models-and-limits",
    title: "数据对象",
    description: "旧文档地址；公开数据对象已经拆分为四份独立文档。",
    group: "数据对象",
    section: "api",
